...
#define DELAY_HEATING_SLOW				80
#define DELAY_HEATING_FAST				150
...
#define TEMPERATURE_START_LIMIT			85
#define CONTROL_RANGE_MIN_TEMPERATURE		15
#define CONTROL_RANGE_MAX_TEMPERATURE   2	
